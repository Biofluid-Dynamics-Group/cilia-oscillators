...
φ = 12.5*π/180.0  # Angle of cilia beat plane
...
# Initial phase
Ψ₀ = [rand(Float64)*2π, 0.0, rand(Float64)*2π, 0.0]
...
p1 = plot(data.time, [data.Ψ_1, data.Ψ_3], label=["ψ₁"], xlabel="t/T")
p2 = plot(data.time, [data.Ψ_2, data.Ψ_4], label=["ψ₂"], xlabel="t/T")
p = plot(p1, p2, layout=(1, 2), title="Simulation 10")
savefig(p, "results/sim10.pdf")
